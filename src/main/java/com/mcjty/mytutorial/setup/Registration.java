...
import static com.mcjty.mytutorial.MyTutorial.*;

import com.mcjty.mytutorial.blocks.ComplexMultipartBlock;
import com.mcjty.mytutorial.blocks.ComplexMultipartTile;
import com.mcjty.mytutorial.blocks.FancyBlock;
import com.mcjty.mytutorial.blocks.FancyBlockTile;
...
import com.mcjty.mytutorial.blocks.MagicBlock;
import com.mcjty.mytutorial.blocks.MagicTile;
import com.mcjty.mytutorial.blocks.StorageBlock;
import com.mcjty.mytutorial.blocks.StorageBlockTile;
...
public class Registration {
	...
	public static final RegistryObject<StorageBlock> STORAGEBLOCK = BLOCKS.register("storageblock", StorageBlock::new);
	public static final RegistryObject<Item> STORAGEBLOCK_ITEM = ITEMS.register("storageblock", () -> new BlockItem(STORAGEBLOCK.get(), new Item.Properties().group(ModSetup.ITEM_GROUP)));
	public static final RegistryObject<TileEntityType<StorageBlockTile>> STORAGEBLOCK_TILE = TILES.register("storageblock", () -> TileEntityType.Builder.create(StorageBlockTile::new, STORAGEBLOCK.get()).build(null));
